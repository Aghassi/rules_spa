...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com_aghassi_rules_spa//spa:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.spainfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@com_aghassi_rules_spa//spa:toolchain_type"],
...
# By default all these toolchains are registered by the spa_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:spa_toolchain",
    toolchain_type = "@com_aghassi_rules_spa//spa:toolchain_type",
)
""".format(
            platform = platform,
